...
=========================================================================*/
// .NAME StreamTracer - Streamline generator
// .SECTION Description
// StreamTracer is a filter that integrates a vector field to generate
// streamlines. The integration is performed using a specified integrator,
// by default Runge-Kutta2.
//
// StreamTracer produces polylines as the output, with each cell (i.e.,
...
//
// StreamTracer supports forward (the default), backward, and combined
...
//
// StreamTracer supports integration through any type of dataset. Thus if
...
#ifndef __StreamTracer_h
#define __StreamTracer_h
...
private:
  StreamTracer(const StreamTracer&);  // Not implemented.
  void operator=(const StreamTracer&);  // Not implemented.
};
