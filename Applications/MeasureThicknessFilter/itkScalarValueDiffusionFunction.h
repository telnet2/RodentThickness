/*=========================================================================
  ...
  Module:    $RCSfile: itkScalarValueDiffusionFunction.h,v $
  Language:  C++
  ...
  See ITKCopyright.txt or http://www.itk.org/HTML/Copyright.htm for details.
     ...
     =========================================================================*/
#ifndef __itkScalarValueDiffusionFunction_h_
#define __itkScalarValueDiffusionFunction_h_
...
/**
 * \class ScalarValueDiffusionFunction
 *
...
class ITK_EXPORT ScalarValueDiffusionFunction
    :public NormalVectorFunctionBase <TSparseImageType> {
public:
    /** Standard class typedef. */
    typedef ScalarValueDiffusionFunction Self;
    typedef NormalVectorFunctionBase <TSparseImageType> Superclass;
    typedef SmartPointer<Self> Pointer;
    typedef SmartPointer<const Self> ConstPointer;

    /** Run-time type information (and related methods) */
    itkTypeMacro( ScalarValueDiffusionFunction, NormalVectorFunctionBase);
...
private:
    ...
    ScalarValueDiffusionFunction(const Self&); //purposely not implemented
...
#include "itkScalarValueDiffusionFunction.hxx"
#endif
