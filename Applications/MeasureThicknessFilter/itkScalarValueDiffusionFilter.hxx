/*=========================================================================
  ...
  Module:    $RCSfile: itkScalarValueDiffusionFilter.hxx,v $
  Language:  C++
  ...
  See ITKCopyright.txt or http://www.itk.org/HTML/Copyright.htm for details.
     ...
     =========================================================================*/
#ifndef __itkScalarValueDiffusionFilter_txx_
#define __itkScalarValueDiffusionFilter_txx_

#include "itkNormalVectorFunctionBase.h"
#include "itkScalarValueDiffusionFilter.h"
#include "itkVector.h"
...
ScalarValueDiffusionFilter<TInputImage, TSparseOutputImage>
::ScalarValueDiffusionFilter() {
    // there is no reason to precompute anything here
    // everything will simply be handled in the ComputeSparseUpdate function of ScalarValueDiffusionFunction
    this->SetPrecomputeFlag(false);
    m_NormalFunction = 0;
