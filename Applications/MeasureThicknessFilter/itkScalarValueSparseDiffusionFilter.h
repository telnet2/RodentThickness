...
// define a node type that includes the indices that are necessary for the updates
// of every element
// in that way we don't need to do if checks all the time
...
/*=========================================================================
  ...
  Module:    $RCSfile: itkScalarValueDiffusionFilter.h,v $
  Language:  C++
  ...
  See ITKCopyright.txt or http://www.itk.org/HTML/Copyright.htm for details.
     ...
     =========================================================================*/
#ifndef __itkScalarValueDiffusionFilter_h_
#define __itkScalarValueDiffusionFilter_h_
...
#include "itkScalarValueDiffusionFilter.hxx"
#endif
